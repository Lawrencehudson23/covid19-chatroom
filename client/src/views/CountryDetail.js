...
export default function CountryDetail({searchCountry}) {
    ...
    useEffect(() => {
        axios({
            ...
            .then((response)=>{
                setErr("")
                if (response.data.message ==='Country not found. Returning all stats. Please use a country name found in the data property.'){
        ...
        <div>
            ...
            <Table size="small" aria-label="a dense table">
                ...
                {country.map((c,i) => (
                    ...
                    <TableCell style={{ color:'red' }} align="right">{c["confirmed"]}</TableCell>
                    <TableCell style={{ color:'red',fontWeight: 'bold' }} align="right">{c["deaths"]}</TableCell>
                    <TableCell style={{ color:'green',fontWeight: 'bold'}}align="right">{c["recovered"]}</TableCell>
                    </TableRow>
                ))}
                </TableBody>
            </Table>
